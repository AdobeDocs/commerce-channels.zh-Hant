...
[!DNL Amazon sales channel] 4.4.1與Adobe Commerce版本2.3.x和2.4.0相容，但只支援Magento Open Source、Adobe Commerce和Adobe Commerce雲基礎架構的2.4.1+版。
...
[!DNL Amazon sales channel] 4.4.0與Adobe Commerce版本2.3.x和2.4.0相容，但只支援Magento Open Source、Adobe Commerce和Adobe Commerce雲基礎架構的2.4.1+版。

此版本 [!DNL Amazon sales channel] 包括以下改進和修復。
...
[!DNL Amazon sales channel] 4.3.0與Adobe Commerce版本2.3.x和2.4.0相容。僅支援2.4.1+版、Magento Open Source版、Adobe Commerce版和Adobe Commerce版的雲基礎架構。
...
[!DNL Amazon sales channel] 4.2.0與Adobe Commerce版本2.3.x相容，但只支援雲基礎架構上的Magento Open Source、Adobe Commerce和Adobe Commerce版本2.4.x。 如果你之前 [!DNL Amazon sales channel] 版本已安裝並嘗試將您的Adobe Commerce更新為2.4.0版，系統會提示您更新擴展，然後您才能完成Adobe Commerce更新。

此版本 [!DNL Amazon sales channel] 包括新功能以及改進和修復。
...
AmazonSales Channel4.1.0與Adobe Commerce2.3.x的Commerce Open Source 、Adobe Commerce和Adobe Commerce在雲基礎架構上相容。 此版本的AmazonSales Channel包括用戶介面增強功能以及少量錯誤修復。
...
AmazonSales Channel4.0.0與雲基礎架構上的Magento Open Source、Adobe Commerce和Adobe Commerce的2.3.0、2.3.1、2.3.2、2.3.3和2.3.4版本相容。 此版本的AmazonSales Channel包括許多用戶介面升級以及少量錯誤修復。
...
AmazonSales Channel3.0.1與Adobe Commerce版本2.2.4+和2.3.x的Magento Open Source、Adobe Commerce和Adobe Commerce的雲基礎架構相容。
...
AmazonSales Channel3.0.0與Adobe Commerce版本2.2.4+和2.3.x的Magento Open Source、Adobe Commerce和Adobe Commerce的雲基礎架構相容。
...
AmazonSales Channel2.0.0與2.2.4+和2.3.x版的雲基礎架構Magento Open Source、Adobe Commerce和Adobe Commerce相容。
